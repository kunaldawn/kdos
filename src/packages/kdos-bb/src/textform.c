...
"#b*** and it is running on KDOS, 29 years later ***#n\n\n"
"#bCHECK OUT http://aa-project.sourceforge.net/#n\n"
"\n"
"First of all\n\n"
"#bControls:#n\n\n"
"#bThis text scrolls itself. The music is the clock.#n\n"
"any key           you take over\n"
...
"#c#bWHAT IS KDOS ?#n\n"
"#c\n"
"#fGood question. You are watching a demo from 1997 on a Linux distribution\n"
"from 2026 that was compiled from source, on purpose, by one person.\n"
"\n"
"KDOS is:\n"
"\n"
"o  #bmusl#n and #btoybox#n. No glibc. No coreutils. No 4 GB of /usr :)\n"
"o  #bNO SYSTEMD.#n Not \"optional\". Not \"you can remove it\". None. Go on,\n"
"   look for it - you just watched the credits say so.\n"
"o  #bNO XORG SERVER.#n Wayland only. Xwayland runs rootless, for aliens.\n"
"o  #bNO GTK AND NO QT ON THE HOST.#n The desktop is a grid of character\n"
"   cells. The taskbar is text. The file dialog is text. The resource\n"
"   monitor is text. We did not port BB to KDOS. We ported KDOS to BB :)\n"
"o  #b430 packages#n, every one of them built here from an upstream tarball.\n"
"o  It builds with the network cable #bOUT#n. Every tarball is in the tree,\n"
"   including a 4 GB container image. Clone, make, get an ISO, no internet.\n"
"o  #bKDOS can build KDOS.#n The stick rebuilds the stick.\n"
"o  The fat applications live in a box and behave like normal apps. The\n"
"   web browser does not get to touch the operating system.\n"
"o  The compositor draws the whole desktop through a phosphor shader, so\n"
"   your 2026 panel spends all day pretending to be a tube. This seemed\n"
"   important.\n"
"\n"
"#bTagline:#n I use KDOS btw.\n"
"#f\n"
"\n#l\n"

/* ----------------------------------------------------- what the fork did */
"#c#bWHAT WE CHANGED IN BB#n\n"
"#c\n"
"#fAlmost nothing, and that is the good news: BB is 1997 C and it still\n"
"compiles. Four things had to move.\n"
"\n"
"o  #bThe mixer got its own thread.#n Upstream pumped MikMod from a 10ms\n"
"   timer in the same group as the frame loop - and that loop had just\n"
"   blocked inside aa_flush() writing a whole screen to the terminal. On a\n"
"   console nobody noticed for 28 years. Under a compositor the sound\n"
"   starved whenever the window was actually being DRAWN, and was perfect\n"
"   the moment you minimised it. A wonderful bug to be handed :)\n"
"o  #btex.c#n cleared sizeof(long) per cell against a sizeof(int)\n"
"   allocation. The same number in 1997. Twice as big on x86_64. The heap\n"
"   had opinions.\n"
"o  #bmessager.c#n scrolled its buffer with memcpy over overlapping ranges.\n"
"   glibc let that go. musl is under no obligation to be so kind.\n"
"o  #bregparm(n)#n is an i386 attribute and this has not been an i386 for\n"
"   some time.\n"
"\n"
"The demo also #bstarts by itself#n now. No Music?[Y/n], no settings table\n"
"waiting for you to find Continue. Use #b-nosound#n or #b-mixer#n if you\n"
"disagree, and #b-loop#n as always.\n"
"\n"
"And this scroll is paced by the #bmodule#n, not by a clock - it asks the\n"
"player where it is and lands on the last page just before bb3.s3m does.\n"
"Touch any key and it hands the wheel back to you for good.\n"
"\n"
"The rest of the demo is exactly as the AA-group left it, which after 29\n"
...
"type kdos-bb --help | more   to get all available options\n\n"
"We can recommend to you the following combinations:\n\n"
"kdos-bb -loop -extended -reverse\n"
"kdos-bb -loop -reverse -nobold -nonormal -nodim\n"
"kdos-bb -loop -nodim -nobold -extended\n"
"kdos-bb -driver stdout -width 79\n"
"kdos-bb -nosound -driver stdout -width 79 > /dev/lp0 (for screenshots :)\n"
"kdos-bb -driver linux            (tty1, at the 512 glyph console font)\n\n"
...
"It now ships on a distribution whose desktop is also made of characters,\n"
"so in a sense BB won.\n"
"\n"
