...
# algebra lands on, named for both BLAS and LAPACK, and allow-noblas=false
# makes a missing openblas.pc fail the build: the fallback is numpy's bundled
# reference kernels, under which every matrix operation is an order of
# magnitude slower and nothing reports it.
