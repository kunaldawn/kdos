...
| Key | Action |
|---|---|
| `Super+Return` | Terminal (`foot`; on the console desktop, whatever `con.conf`'s `terminal` names — your login shell (`$SHELL`) by default, in a window the session runs itself) |
