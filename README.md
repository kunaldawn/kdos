...
<p align="center">
<sub>813 ports · Linux 7.0.10 · 810 packages · 182 containerised applications · builds offline from this repo</sub>
</p>
...
upstream tarballs by 813 recipes: cross toolchain → musl userland →
...
```
ports/core/       813 upstream ports, two files each
